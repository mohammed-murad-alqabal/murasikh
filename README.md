...
| 📚 **قاعدة معرفة شرعية** | 6,236 آية + 36,000+ حديث مع التفاسير |
...
|---------|-------|--------|-------|
| **P1: MVP** | 18 أسبوع | 🔵 جاري | إدخال نصي + توصيات أساسية |
| **P2: الوسائط** | 6 أشهر | ⚪ مخطط | تحليل الصوت والصورة |
| **P3: التعلم** | 4 أشهر | ⚪ مخطط | تحسين التوصيات بالتعلم |
| **P4: التخصيص** | 3 أشهر | ⚪ مخطط | خيارات متقدمة للمستخدم |
| **P5: الإطلاق** | شهرين | ⚪ مخطط | النشر على المتاجر |

📖 **للتفاصيل:** [خطة التنفيذ](./docs/plans/todo-1.md)
...
| التقنية | الاستخدام |
|---------|----------|
| **GATE-AraBERT-v1** | Embeddings للعربية |
...
- احترم [قواعد السلوك](CODE_OF_CONDUCT.md)
