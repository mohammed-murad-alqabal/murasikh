...
| 🔒 **الخصوصية** | secure storage للرموز، والتحقق الكامل للبيانات المحلية ما يزال قيد التنفيذ |
...
| **P4: الأمان** | 3 أشهر | 🟡 منفذ جزئياً | JWT وتصدير؛ تشفير التخزين والحذف الكامل قيد التنفيذ |
| **P5: الإطلاق** | شهرين | ⚪ مؤجل | staging والمتاجر والتوقيع والمراقبة والاستعادة |

📖 **للتفاصيل:** [خطة التنفيذ](./docs/plans/todo_3.md)

📊 **الحالة الرسمية:** [مصفوفة حالة المنتج](./docs/حالة-المنتج-2026-09-22.md)
