...
نحتاج إلى قاعدة بيانات متجهية (Vector Database) لتخزين واسترجاع الـ Embeddings للآيات والأحاديث للبحث الدلالي.

### المتطلبات

1. **حجم البيانات:** ~42,000 متجه (6,236 آية + ~36,000 حديث)
