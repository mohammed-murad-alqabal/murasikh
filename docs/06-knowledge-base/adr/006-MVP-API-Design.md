...
## الحالة
مستبدل — العقد التشغيلي الحالي في [`docs/03-api/العقد-المعتمد.md`](../../../docs/03-api/العقد-المعتمد.md)

> هذا ADR يحتفظ بالسياق التاريخي لتصميم MVP. لا تستخدم مساراته أو نماذج استجابته كعقد تنفيذ.
