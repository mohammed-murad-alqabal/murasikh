...
> **ملاحظة الحالة:** هذه خطة تاريخية ومرجع لتطور MVP. العقد التنفيذي الحالي للمسارات والحقول هو [`docs/03-api/العقد-المعتمد.md`](../03-api/العقد-المعتمد.md)، وحالة الميزات الرسمية في [`docs/حالة-المنتج-2026-09-22.md`](../حالة-المنتج-2026-09-22.md).
