...
class HistoryService {
  ...
  Future<List<HistoryItem>> getHistory() async {
    ...
    try {
      for (final raw in _box.values) {
        try {
          ...
          debugPrint('Error decoding JSON for history item: $e');
        }
      }
    } catch (e) {
    ...
    try {
      ...
      debugPrint('Error syncing history with server: $e');
  ...
  Future<void> updateFeedback(String id, int feedbackValue) async {
    ...
    try {
      ...
      debugPrint('Error updating local history feedback: $e');
    }
    ...
    try {
      ...
      debugPrint('Error updating remote history feedback: $e');
    }
  }
  ...
  Future<bool> clearHistory() async {
    ...
    try {
      ...
      debugPrint('Error clearing remote history: $e');
    }
    if (remoteCleared) {
      try {
        await _box.clear();
      } catch (e) {
        debugPrint('Error clearing local history box: $e');
      }
    }
  ...
  Future<List<DelayedResponseItem>> getDueDelayedResponses() async {
    try {
      ...
      debugPrint('Error fetching due delayed responses: $e');
      return [];
    }
  }
}
